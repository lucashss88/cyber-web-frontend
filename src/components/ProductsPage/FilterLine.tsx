  ...
  return (
    <div className="bg-white py-11 flex justify-center items-center relative">
        <div className="bg-white w-86 flex justify-around items-center" id='filter-line-container'>
            <div className="bg-white border border-d4 filter-box flex items-center justify-around min-w-41 min-h-14 px-2 rounded-md cursor-pointer" onClick={toggleMobileFilter}>
                <span className='text-sm font-normal'>Filters</span>
                <img src={filterIcon} alt="filter-icon" className='w-6'/>
            </div>
            {showMobileFilter && <MobileFilter onClose={toggleMobileFilter}/>}
            ...
            <div className="bg-white border border-d4 filter-box flex items-center justify-around min-w-41 min-h-14 px-2 rounded-md relative">
                <select className='flex-1 text-xs bg-transparent outline-none appearance-none font-normal text-gray-700' name="byPrice" id="byPriceSelect" value={order} onChange={handleChange}>
